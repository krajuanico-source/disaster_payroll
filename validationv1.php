        ...
        <div class="table-responsive">  
            <table id="payrollTable" style="width:100%" class="table table-bordered table-striped">
                ...
                <tbody>
					...
					$sql = "SELECT  CONCAT(first_name, ' ', middle_name, ' ', last_name,' ',extension_name) AS fullname,   CONCAT(birth_month, '- ', birth_day, '-', birth_year) AS  dob,status,payroll_no,payroll_id,id,city_municipality,barangay
								FROM  ect_clean_list 	WHERE  payroll_no = $payroll_no;"; 
					...
					if ($result->num_rows > 0) {
						...
						// Fetch necessary values
								...
								echo "<td>" . $ctr . "</td>";
								echo "<td>";
										echo "<span>" . str_replace('Ã', 'Ñ',$row['fullname']). " </span>
									  </td>";
								echo "<td>" . $row['dob'] . "</td>";
								echo "<td>" . $row['city_municipality'] .' '.$row['barangay']. "</td>";
