            ...
            <table id="payrollTable" style="width:100%" class="table table-bordered table-striped">
				...
				if ($result1->num_rows > 0) {
					while ($row1 = $result1->fetch_assoc()) {
						...
						$payroll_no = $payrollNoRow['payroll_no'];
						$sqls = "SELECT COUNT(id) as bene_count FROM ect_clean_list WHERE payroll_no='$payroll_no' and status in ('Validated','Claimed')";
						...
						if ($result1 && $rows = $results->fetch_assoc()) {
							...
							echo "<td>" . $payrollNoRow['payroll_no'] . "</td>";
							echo "<td>" . $program . "</td>";
							echo "<td>" . $province . "</td>";
							echo "<td>" . $date_created . "</td>";
							echo "<td>" . $amount . "</td>";
							echo "<td>" . ($city_muni ? $city_muni : 'N/A') . "</td>";
							echo "<td>" . (isset($sdonum) && $sdonum !== '' ? $sdonum : 'N/A') . "</td>";
					...
					echo "<tr><td class='text-center'>No payroll records found</td>	
